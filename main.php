    ...
    <div class="row justify-content-center">
        ...
        <div class="col-sm-9">
            <?php
                ...
                if (mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' $kategori_id")) == 0){
                    echo "<div class='alert alert-warning' role='alert'>Belum ada barang!</div>";
                } else {
                    $data_per_halaman = 6;
